 ...
 *               $ref: "#/components/schemas/ErrorResponse"
 */
authRouter.post("/verify-user", validateMiddleware(verifyUserSchema), AuthService.verifyUser);
/**
 * @openapi
 ...
 *               $ref: "#/components/schemas/ErrorResponse"
 */
authRouter.post("/resend-verification-code", validateMiddleware(resendVerificationCodeSchema), AuthService.resendVerificationCode);
/**
 * @openapi
 * /auth/current-user:
 *   get:
